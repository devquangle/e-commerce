...
public class GlobalExceptionHandler {
        ...
        // Duplicate field validation errors (must be before AppException)
        @ExceptionHandler(DuplicateFieldException.class)
        public ResponseEntity<ResponseData> handleDuplicate(DuplicateFieldException ex) {
                log.warn("DuplicateFieldException: {}", ex.getErrors());
