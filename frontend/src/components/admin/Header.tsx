...
export default function Header() {
  ...
  const user_code = () => {
    const username =
      isInitialized && userInfo?.code ? userInfo.code : "Account";
    return username;
  };
            ...
            <div className="flex items-center shrink-0">
              ...
              >
                <button
                  ...
                  className="flex items-center gap-2 rounded-full border px-3 py-1.5 bg-white hover:bg-gray-50 transition-colors select-none"
                >
                  <img
                    ...
                    alt="Avatar"
                  />
                  <span className="max-w-[100px] truncate block text-sm font-medium">
                    {user_code()}
                  </span>
                </button>
                      ...
                      {menuItems.map((item) => (
                        <li key={item.id}>
                          {item.path ? (
                            ...
                            <button
                              className="flex w-full text-left px-4 py-2.5 rounded-lg hover:bg-red-50 text-red-600 font-medium transition-colors"
                              onClick={item.action}
                            >
                              {item.label}
                            </button>
