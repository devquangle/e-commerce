...
export default function CreateProduct() {
  ...
  const handleSubmit = async (e: React.FormEvent, isDraft = false) => {
    ...
    try {
      ...
      showSuccessToast(isDraft ? "Đã lưu bản nháp sách thành công!" : "Tạo sách mới thành công!");
  ...
  return (
    <section className="space-y-6 p-4 md:p-6 flex-1 max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between pb-4 border-b border-slate-200/60">
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Thêm sách mới</h1>
          </div>
        </div>
      ...
      {/* FORM BODY */}
      <form id="create-product-form" className="grid gap-6 lg:grid-cols-3 align-start" onSubmit={(e) => handleSubmit(e, false)}>
